...
public interface IUsuarioDao extends CrudRepository<Usuario, Long> {
	...
	@Query(value = "Select u.username,p.cedula,p.nombre,p.apellido,u.enabled,u.id_usuario,u.password,u.id_persona, u.rol_id from usuario u join persona p on u.id_persona = p.id_persona", nativeQuery = true)
