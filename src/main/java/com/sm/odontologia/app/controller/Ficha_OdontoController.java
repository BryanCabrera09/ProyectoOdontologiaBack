...
public class Ficha_OdontoController {
    ...
    public ResponseEntity<Ficha_odontologica> actualizarFicha(@PathVariable Long id, @RequestBody Ficha_odontologica f) {
        ...
        if (fichaOdontologica == null) {
            ...
            try {
                ...
                fichaOdontologica.setAntecedentes(f.getAntecedentes());
                fichaOdontologica.setExamenes(f.getExamenes());
